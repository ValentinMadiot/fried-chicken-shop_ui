...
sr.reveal(".home__data, .about__data, .footer__container, .footer__copy");
...
sr.reveal(".contact__dam-3", { delay: 1400, scale: 0, rotate: { z: 45 } });
sr.reveal(".contact__dam-2", { delay: 1600, scale: 0, rotate: { z: 45 } });
sr.reveal(".contact__dam-4", { delay: 1800, scale: 0, rotate: { z: 45 } });
